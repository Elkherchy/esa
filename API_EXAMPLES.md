...
```json
{
  ...
  "analyzed": true,
  "analysis": {
    "summary": "Ce rapport présente une analyse complète des performances financières de l'entreprise pour l'année 2024. Les résultats montrent une croissance de 23% du chiffre d'affaires avec une expansion réussie sur les marchés internationaux.",
    "key_points": [
      "Croissance de 23%",
